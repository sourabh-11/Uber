...
const UserSign = () => {
  ...
  return (
    <div className="p-7 flex flex-col justify-between h-screen">
      ...
      <div>
        <p className="text-[6px]">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Neque quo velit, reiciendis aspernatur ullam quam non, fugit dolore necessitatibus, aut libero doloribus eos error corrupti dolor aliquid culpa eum debitis quisquam odio nam!</p>
      </div>
